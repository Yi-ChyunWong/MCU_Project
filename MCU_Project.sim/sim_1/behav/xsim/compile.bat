...
REM
REM Generated by Vivado on Tue Jul 14 10:19:07 -0400 2026
...
echo "xvlog --incr --relax -L uvm -prj addOne_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj addOne_tb_vlog.prj -log xvlog.log
